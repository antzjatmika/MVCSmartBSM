...
namespace MVCSmartClient01.Controllers
{
    ...
    public class TrxAsistenController : Controller
    {
        HttpClient client;
        private readonly ITokenContainer tokenContainer;
        //The URL of the WEB API Service
        //string url = "http://localhost:2070/api/TrxAsisten";
        string url = string.Empty;

        //The HttpClient Class, this will be used for performing 
        //HTTP Operations, GET, POST, PUT, DELETE
        //Set the base address and the Header Formatter
        public TrxAsistenController()
        {
            string SmartAPIUrl = ConfigurationManager.AppSettings["SmartAPIUrl"];
            url = string.Format("{0}/api/TrxAsisten", SmartAPIUrl);
        ...
        public async Task<ActionResult> Index()
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var Employees = JsonConvert.DeserializeObject<List<trxAsisten>>(responseData);
        ...
        {
            return View(new trxAsisten());
        }

        //The Post method
        [HttpPost]
        public async Task<ActionResult> Create(trxAsisten Emp)
        {
        ...
        public async Task<ActionResult> Edit(int id)
        {
            ...
            {
                var responseData = responseMessage.Content.ReadAsStringAsync().Result;
                var Employee = JsonConvert.DeserializeObject<trxAsisten>(responseData);
        ...
        //The PUT Method
        [HttpPost]
        public async Task<ActionResult> Edit(int id, trxAsisten Emp)
        {
        ...
        //The DELETE method
        [HttpPost]
        public async Task<ActionResult> Delete(int id, trxAsisten Emp)
        {
