...
namespace MVCSmartClient01.Controllers
{
    ...
    public class TrxDetailPekerjaanAS_1MController : Controller
    {
        HttpClient client;
        ...
        public TrxDetailPekerjaanAS_1MController()
        {
        ...
        public async Task<ActionResult> _GetByRekanan()
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                myDataForm.DetailPekerjaanAS_1MColls = myData;
        ...
        public async Task<ActionResult> _AddEditDetail(int IdData)
        {
            ...
            //else
            //{
            //    trxDetailPekerjaanSingle myDataForm = new trxDetailPekerjaanSingle();
            //    myDataForm.MaxYear = DateTime.Today.Year;
            //    myDataForm.GuidHeader = Guid.Empty;

            //    switch ((int)tokenContainer.IdTypeOfRekanan)
            //    {
            //        case 2: //KAP
            //            return View("_AddEditDetailKAP", myDataForm);
            //        case 7: //NOTARIS
            //            return View("_AddEditDetailNOT", myDataForm);
            //        default: //KJPP, Konsultan Management, Balai Lelang
            //            return View("_AddEditDetailOTH", myDataForm);
            //    }
            //}
        }
        ...
        public async Task<ActionResult> _Delete(int id)
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var Employee = JsonConvert.DeserializeObject<trxDetailPekerjaan>(responseData);
