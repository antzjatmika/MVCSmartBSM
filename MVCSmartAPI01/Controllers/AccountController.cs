...
using MVCSmartAPI01.Providers;
using MVCSmartAPI01;
using MVCSmartAPI01.Results;
...
namespace LocalAccountsApp.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private TrxRegistrationRequestRep _repRegRequest;
        public AccountController()
        {
        }

        public AccountController(ApplicationUserManager userManager, ISecureDataFormat<AuthenticationTicket> accessTokenFormat
            , MstRekananRep repRekanan, mstEmailPoolRep repEmailPool, TrxRegistrationRequestRep repRegRequest)
        {
            UserManager = userManager;
            AccessTokenFormat = accessTokenFormat;
            _repRekanan = repRekanan;
            _repEmailPool = repEmailPool;
            _repRegRequest = repRegRequest;
        }
        ...
        [Route("api/Account/Register/{strNamaRekanan}/{strNomorNPWP}/{strEmail}")]
        public async Task<IHttpActionResult> Register(string strEmail, string strPassword)
        {
            //PROSES DAFTARKAN USER
        ...
        [Route("api/Account/Register1")]
        public IHttpActionResult Register1(RegisterBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
